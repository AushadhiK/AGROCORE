                  ...
                  <div className="col-md-4">
                    <div className="mb-3">
                      ...
                      <div className="input-group">
                        <input 
                          type="text" className={`form-control ${errors.FarmerRegNo ? 'is-invalid' : ''}`}  id="FarmerRegNo"  name="FarmerRegNo" value={formData.FarmerRegNo} onChange={handleChange}  disabled/>
